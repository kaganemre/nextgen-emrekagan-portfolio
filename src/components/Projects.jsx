  ...
  return (
    <>
      ...
      <section className="flex flex-col gap-5 projects-list">
        <p className="text-5xl text-ninth-color font-semibold mb-3">
          {projects.title}
        </p>
            ...
            >
              ...
              <div className="flex gap-1 mt-7 mb-3">
                {projectsDetail.tech.map((t, i) => (
                  <button
                    key={i}
                    className="border border-primary-color w-[68px] h-[30px] text-sm font-medium text-primary-color rounded px-4"
                  >
                    {t}
                  </button>
                ))}
